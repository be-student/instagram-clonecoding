...
const SuggestionsPanel: React.FC = () => {
  ...
  const suggestions: SuggestionProps[] = [
    { username: "hwank_mobydicck", description: "회원님을 위한 추천", imageUrl: "https://via.placeholder.com/36" },
    { username: "soda_power", description: "회원님을 팔로우합니다", imageUrl: "https://via.placeholder.com/36" },
    { username: "cloud_architect", description: "인기", imageUrl: "https://via.placeholder.com/36" },
    { username: "bae_e04", description: "instagram 신규가입", imageUrl: "https://via.placeholder.com/36" },
    { username: "2jo_official", description: "회원님을 팔로우합니다", imageUrl: "https://via.placeholder.com/36" }
  ];

  return (
    <div className="w-[300px] px-4 ml-6 hidden lg:block">
      {/* 사용자 프로필 */}
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center">
          ...
          />
          <div>
            <h4 className="font-semibold text-sm">gyucoder</h4>
            <p className="text-sm text-gray-500">송규</p>
          </div>
        </div>
        <button className="text-xs font-semibold text-[#0095f6]">전환</button>
      </div>
