...
const LoginForm: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-[350px]">
      <div className="bg-white border border-gray-300 px-10 py-8 text-center space-y-4 rounded-sm">
        <h1 className="text-5xl font-normal mb-4" style={{ fontFamily: '"Billabong", "Grand Hotel", cursive' }}>Instagram</h1>
        ...
        <div className="flex items-center my-3">
          ...
          <span className="px-4 text-xs font-medium text-gray-500">또는</span>
          <div className="flex-grow border-t border-gray-300"></div>
        </div>

        <button className="text-sm font-semibold text-[#385185] flex items-center justify-center w-full">
      ...
      <div className="bg-white border border-gray-300 p-4 text-center mt-3 rounded-sm">
        <p className="text-sm">
          계정이 없으신가요?{' '}
